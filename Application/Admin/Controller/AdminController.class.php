...
//     		);
            ...
            $b = array(
                'MAIL_HOST' =>I("post.mail_smtp"),//smtp服务器的名称
                'MAIL_USERNAME' =>I("post.mail_address"),//你的邮箱名
                'MAIL_FROM' =>I("post.mail_address"),//发件人地址
                'MAIL_FROMNAME'=>I("post.mail_formname"),//发件人姓名
                'MAIL_PASSWORD' =>I("post.mail_password"),//邮箱密码
            );
            ...
            $settingstr.="),\n);\n?>\n";
            file_put_contents(__ROOT__.'Application/Admin/Conf/config.php',$settingstr); //通过file_put_contents保存setting.config.php文件；
