...
//			}
    ...
    if(type == "c_manage"){
        ...
        if(pwd_status != 1){
            ...
            $.get(type+".html", {sel:'upd', id:$("#id").val(), userid:$("#userid").val(), uname:$("#uname").val(), phone:$("#phone").val(), email:$("#email").val(), qq:$("#qq").val(), sid:$("[name='sid']").val(), u_status:$("[name='u_status']").val()}, function(data){
                if(data == 1){
                    alert("修改成功");
                    history.go(0);
                }
