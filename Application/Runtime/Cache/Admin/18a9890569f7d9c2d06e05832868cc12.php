...
<div class="mainwrapper">
    <div class="header">
        <div class="logo">
            <a href="<?php echo U('Console/dashboard');?>"><img src="<?php echo (C("URL")); ?>/images/logo1.png" alt="" width="70%"/></a>
        </div>
            ...
            <ul class="headmenu">
                <li class="odd">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        ...
                        <span class="headmenu-label" style="font-size: 14px;">工单管理</span>
                    </a>
                ...
                <li class="right">
                    <div class="userloggedinfo">
                        ...
                        <div class="userinfo">
                            <ul>
                                <li><a href="javascript: void(0);"><?php echo (session('uname')); ?> <small> <?php echo (session('email')); ?></small></a></li>
...
<!--&lt;!&ndash; 	                                            <a href="javascript:void();" onclick="RemainTime();" class="btn" id="zphone" style="color:#555;">获取手机验证码</a> &ndash;&gt;-->
	                                        <!--</p>-->
	                                        <p>
	                                            <label>email：</label>
        		 ...
        		 <!-- footer binge -->
                    ...
                    <div class="footer-left">
                        <span>&copy; 2017. <a href="http://119.23.237.174" target="_blank">TK-会员中心</a> 版权所有，翻印必究。</span>
                    </div>
                    <div class="footer-right">
                        <span><a href="http://119.23.237.174" target="_blank"> TK-会员中心</a></span>
                    </div>
                </div><!--footer-->
