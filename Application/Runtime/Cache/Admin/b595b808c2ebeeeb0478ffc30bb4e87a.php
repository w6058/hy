...
<body class="loginpage">
    <div class="loginpanel">
        <div class="loginpanelinner">
            <div class="logo animate0 bounceIn" style="width: 250px"><img src="<?php echo (C("URL")); ?>images/logo1.png" alt="logo" /></div>
    ...
    <div class="loginfooter">
        <p>&copy; 2017.  <a href="http://119.23.237.174" target="_blank"> TK-会员中心</a> 版权所有，翻印必究。</p>
    </div>
