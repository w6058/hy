...
<div class="page-content-inner">
    ...
    <section class="panel">
        <div class="panel-heading">
            <h3><?php echo ($shop["0"]["s_name"]); ?> 详情</h3>
        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="margin-bottom-50">
                        ...
                        <br />
                        <!-- Horizontal Form -->
                        <!--<form method="post" action="/index.php/Home/Admin/update">-->
                        <form action="/index.php/Home/admin/update" method="post">
                            <input type="text" value="<?php echo ($shop[0][id]); ?>" style="display: none" name="id" class="form-control"  >
                            <div class="form-group row">
                                <div class="col-md-3">
                                    <label class="form-control-label">商户名称</label>
                                </div>
                                <div class="col-md-9">
                                    <input type="text" disabled value="<?php echo ($shop[0]['s_name']); ?>" name="s_name" class="form-control" >
                                </div>
                            </div>
							<div class="form-group row">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-9">
                                    <input type="text" disabled value="<?php echo ($shop[0]['s_username']); ?>" name="s_username" class="form-control" >
                                </div>
                            </div>
							<div class="form-group row">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-9">
                                    <div class="form-input-icon form-input-icon-right">
                                        ...
                                        <input type="text" value="<?php echo ($shop[0][s_password]); ?>" class="form-control" name="s_password" >
                                    </div>
                                </div>
                            </div>
							<div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        ...
                                        <input type="email" value="<?php echo ($shop[0][s_email]); ?>" class="form-control" name="s_email" >
                                    </div>
                                </div>
                            </div>
							<div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" value="<?php echo ($shop[0][s_address]); ?>" name="s_address"  class="form-control" >
                                </div>
                            </div>
							<div class="form-group row">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-9">
                                    <input type="text" value="<?php echo ($shop[0]['s_license']); ?>" name="s_license"  class="form-control" >
                                </div>
                            </div>
							<div class="form-group row">
                                <div class="col-md-3">
                            ...
                            <div class="form-actions">
                                <div class="form-group row">
                                    <div class="col-md-9 col-md-offset-3">
                                        <button type="submit" class="btn width-150 btn-primary">更新</button>
