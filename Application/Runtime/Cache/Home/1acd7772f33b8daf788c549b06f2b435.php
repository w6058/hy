            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="margin-bottom-50">
                        ...
                        <!-- Horizontal Form -->
                        <form method="post" class="row" action="/index.php/Home/admin/message2" enctype="multipart/form-data">
                            <div class="form-group col-md-5 col-md-offset-3">
                                <br />
                                <input type="text" class="form-control" id="title" name="title" value="<?php echo ($message["title"]); ?>">
                            </div>
                            <div class="form-group col-md-12">
                                <textarea name="content" id="content" value="<?php echo ($message["content"]); ?>"></textarea>
                            </div>
                            <div class="form-actions">
                                <div class="form-group">
                                    <div class="col-md-12" style="text-align: center">
                                        <button type="submit" class="btn width-150 btn-primary">发送</button>
