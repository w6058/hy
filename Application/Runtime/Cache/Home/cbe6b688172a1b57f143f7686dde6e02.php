        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <br />
                     <form method="post" action="/hy2/index.php/Home/admin/sureAddMemberClass">

                            <div class="form-group row">
                                <div class="col-md-3">
                                    <label class="form-control-label" for="l0">会员称号</label>
                                </div>
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="m_level" placeholder="会员称号">
                                </div>
                            </div>

                            <div class="form-group row">
                                <div class="col-md-3">
                                    <label class="form-control-label" for="l0">会员条件</label>
                                </div>
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="term" placeholder="会员条件">
                                </div>
                            </div>
