...
<div class="page-content-inner" style="background-image: url(/hy/Public/assets/common/img/temp/login/3.jpg)">
    ...
    <div class="single-page-block">
        <div class="single-page-block-inner effect-3d-element">
            ...
            <div class="single-page-block-form">
                <!--<form id="form-validation" name="form-validation" method="POST" action="/hy/index.php/Home/shop/addmember2">-->
...
<script>
    $(function() {
        ...
        $('#m_card').on('change',function () {
            ...
            $.ajax({
                url:'/hy/index.php/Home/shop/findmember',
                type:'post',
                data:{
                    'm_card':m_card
                },
        ...
        $("#button_zc").on('click',function () {
            ...
            if(m_card==''){
                ...
                $.ajax({
                    url:'/hy/index.php/Home/shop/addmember2',
                    type:'post',
                    data:{
                        'm_card':m_card,
