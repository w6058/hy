        ...
        <div class="menu-info-block">
            ...
            <div class="left hidden-md-down">
                <div class="example-top-menu-chart">
                    ...
                    <?php if(session('messagesnum') != 0): ?><a href="javascript:void(0)" id="messagesnums">
                            <i class="fa fa-envelope-o" style="font-size: 20px;">
                                <span style="color: white;position: relative;right: 9px;background-color: red;top: -12px;text-align: center;font-size: 10px;padding: 2px 3px 1.5px 3px;line-height: 10px;border-radius: 50%;"><?php echo session('messagesnum');?></span>
                            </i>
                        </a><?php endif; ?>
        ...
        <div class="single-page-block-inner effect-3d-element">
            ...
            <div class="single-page-block-form">
                <form id="form-validation" action="" name="form-validation" method="POST">
                    ...
                    <br />
                    <div class="form-group">
                        <span style="color: black;margin-left: 19px;">充值描述:</span>
                        <textarea id="goods" name="goods" placeholder="充值描述" class="form-control" rows="3" cols="45"></textarea>
                    </div>
                    <br />
                    <div class="form-group">
                        <input id="num"
    ...
    $(function() {
        ...
        $("#button_cz").on('click',function () {
            ...
            if(m_card==''){
                ...
                if(a==1){
                    $.ajax({
                        url:'/index.php/Home/shop/memberadd2',
                        type:'post',
                        data:{
                            'm_card':m_card,
                            'checked':$(".rel:checked").val(),
...
<script>
    $(function() {
        $('#messagesnums').on('click',function () {
            $.ajax({
                url:'/index.php/Home/message/messagesnum',
                type:'post',
                success:function (msg) {
                    console.log(msg);
                    if(msg.status == 'ok'){
