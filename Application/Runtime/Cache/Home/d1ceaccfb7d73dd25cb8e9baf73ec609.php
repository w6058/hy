                    ...
                    <div class="margin-bottom-50">
                        <table class="table">
                            ...
                            <?php if(empty($shops)): ?><tr>
                                    <td style="border: 1px solid black;" colspan="10">该商城还未入住任何商家</td>
                                </tr><?php endif; ?>
                            <?php if(!empty($shops)): if(is_array($shops)): foreach($shops as $key=>$shop): ?><!--<?php var_dump($val) ?>-->
                                    <tr>
                                        <td><?php echo ($key+1); ?></td>
                                        <td><?php echo ($shop["s_name"]); ?></td>
                                        <td><?php echo ($shop["s_username"]); ?></td>
                                        <td><?php echo ($shop["s_num"]); ?></td>
                                        <td><a href="/index.php/Home/admin/shopmember?id=<?php echo ($shop["id"]); ?>"><span class="label label-primary">会员列表</span></a></td>
                                        <td><a href="/index.php/Home/admin/smcash?id=<?php echo ($shop["id"]); ?>"><span class="label label-primary">消费日志</span></a></td>
                                        <td><a href="/index.php/Home/admin/sadd?id=<?php echo ($shop["id"]); ?>"><span class="label label-primary">充值日志</span></a></td>
                                        <td><a href="/index.php/Home/admin/addcard?id=<?php echo ($shop["id"]); ?>"><span class="label label-primary">办卡日志</span></a></td>
                                        <td><a href="/index.php/Home/admin/shopinfo?id=<?php echo ($shop["id"]); ?>"><span class="label label-primary">商户详情</span></a></td>
                                        <td><a href="/index.php/Home/admin/cash?id=<?php echo ($shop["id"]); ?>"><span class="label label-primary">资金操作</span></a></td>
                                    </tr><?php endforeach; endif; ?>
                                <tr><td colspan="10" style="text-align: right;font-size: 15px;"><?php echo ($page); ?></td></tr><?php endif; ?>
                            </tbody>
                        </table>
                    </div>
                </div>
