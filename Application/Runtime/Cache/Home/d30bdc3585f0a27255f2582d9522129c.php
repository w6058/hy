...
<head lang="en">
    ...
    <link rel="stylesheet" type="text/css" href="/hy2/Public/assets/vendors/chartist.min.css">
...
<div class="page-content-inner">
    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-lg-12">
                    <h4>商户名称：<?php echo ($shop[0]['s_name']); ?></h4>
                        ...
                        <table class="table table-hover">
                            ...
                            <?php if(is_array($members)): foreach($members as $key=>$member): ?><!--<?php var_dump($val) ?>-->
                                <tr>
                                    ...
                                    <td><a href="/hy2/index.php/Home/admin/memberInfo?id=<?php echo ($member["id"]); ?>"><span class="label label-primary">会员详情</span></a></td>
                                </tr><?php endforeach; endif; ?>
                            <tr><td colspan="10" style="text-align: right;font-size: 15px;"><?php echo ($page); ?></td></tr>
                            </tfoot>
                            <tbody>
