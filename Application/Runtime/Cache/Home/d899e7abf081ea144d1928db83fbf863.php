                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                                    	<form action="/index.php/Home/Admin/vipClassSetUp" method="post">
	                                        <td>
		                                        <?php echo ($vo["id"]); ?>
	                                        ...
	                                        <td>
	                                        	<a href="/index.php/Home/admin/deleMemberClass?id=<?php echo ($vo["id"]); ?>">
                                ...
                                <tr>
                                	<td colspan="4" style="text-align: center;">
                                		<a href="/index.php/Home/Admin/addMemberClass">
