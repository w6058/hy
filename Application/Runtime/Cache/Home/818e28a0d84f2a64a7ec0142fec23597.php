            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="margin-bottom-50">
                        ...
                        <h5><?php echo ($ref); ?></h5>
                        <!-- Horizontal Form -->
                        <form method="post" action="/hy2/index.php/Home/admin/updateMember">
                            ...
                            <div class="form-group row">
                                <div class="col-md-3">
                                    <label class="form-control-label" for="l0">会员等级</label>
                                </div>
                                <div class="col-md-9">
                                    <select name="l_id" class="form-control" id="selcet">
                                        <?php if(is_array($list)): foreach($list as $k=>$v): ?><span><?php echo ($v["id"]); ?></span>
                                            <?php if($v['id'] == $vo['l_id']): ?><option value="<?php echo ($v["id"]); ?>" selected><?php echo ($v["m_level"]); ?></option>
                                            <?php else: ?>
                                                <option value="<?php echo ($v["id"]); ?>"><?php echo ($v["m_level"]); ?></option><?php endif; endforeach; endif; ?>
                                    </select>
                                </div>
                            </div>
							<div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="m_num" value='<?php echo ($vo["m_num"]); ?>' disabled="disabled"  placeholder="9993">
                                </div>
                            </div>
							<div class="form-group row">
                                <div class="col-md-3">
							...
							<div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <div class="form-input-icon form-input-icon-right">
                                        ...
                                        <input type="text" class="form-control" name="m_password" value='<?php echo ($vo["m_password"]); ?>' placeholder="Password">
                                    </div>
                                </div>
                            </div>
							<div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        ...
                                        <input type="email" class="form-control" name="m_email" value='<?php echo ($vo["m_email"]); ?>' placeholder="会员邮箱">
                                    </div>
                                </div>
                            </div>
							<div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="m_address" value='<?php echo ($vo["m_address"]); ?>' placeholder="请输入会员地址">
                                </div>
                            </div>
							<div class="form-group row">
                                <div class="col-md-3">
                                    <label class="form-control-label" for="l1">会员紧急联系人</label>
                                </div>
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="m_phonenum" value='<?php echo ($vo["m_phonenum"]); ?>' placeholder="请输入紧急联系人姓名和电话" >
                                </div>
                            </div>
							<div class="form-group row">
                                <div class="col-md-3">
                            ...
                            <div class="form-actions">
                                <div class="form-group row">
                                    <div class="col-md-9 col-md-offset-3">
                                        ...
                                        <a href="/hy2/index.php/Home/admin/show">
