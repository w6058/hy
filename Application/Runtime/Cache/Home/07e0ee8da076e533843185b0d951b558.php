...
<div class="page-content-inner">
    ...
    <section class="panel">
        <div class="panel-heading">
            <h3><?php echo ($shop["0"]["s_name"]); ?> 充值日志</h3>
        </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="margin-bottom-50">
                        <table class="table table-inverse">
                            ...
                            <tbody>
                            <?php if(is_array($lists)): foreach($lists as $key=>$list): ?><!--<?php var_dump($val) ?>-->
                                <tr>
                                    <td><?php echo ($key+1); ?></td>
                                    <td><?php echo ($list["m_nickname"]); ?></td>
                                    <td><?php echo ($list["m_username"]); ?></td>
                                    <td><?php echo ($list["m_phone"]); ?></td>
                                    <td><?php echo ($list["grade"]); ?></td>
                                    <td><?php echo ($list["gradetime"]); ?></td>
