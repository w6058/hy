    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-lg-6">
                    <h4>充值记录</h4>
                    <!--<p>Modifier: <code>.table-striped</code></p>-->
                    <br />
                    <div class="margin-bottom-50">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <?php if(is_array($list1)): foreach($list1 as $key=>$vo): ?><th scope="row"><?php echo ($vo["id"]); ?></th>
                                    <td><?php echo ($vo["s_name"]); ?></td>
                                    <td><?php echo ($vo["grade"]); ?></td>
                                    <td><?php echo ($vo["gradetime"]); ?></td><?php endforeach; endif; ?>
                            </tbody>
                        </table>
                    </div>
                </div>
                <div class="col-lg-6">
                    <h4>消费记录</h4>
                    <!--<p>Modifier: <code>.table-hovered</code></p>-->
                    <br />
                    <div class="margin-bottom-50">
