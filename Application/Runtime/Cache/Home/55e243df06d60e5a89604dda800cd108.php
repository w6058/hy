            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="margin-bottom-50">
                        <h4>新增商户子账号</h4>
                        <br />
                        <form method="post" action="/index.php/Home/shop/addshopadmin2" enctype="multipart/form-data">
                            <h5 style="color:red;"><?php echo ($error); ?></h5>
                            <h5 style="color:red;"><?php echo ($success); ?></h5>
							<div class="form-group row">
                                <div class="col-md-2 col-lg-offset-1">
                                    <label class="form-control-label">管理员姓名</label>
                                </div>
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="s_name" placeholder="管理员姓名">
                                </div>
                            </div>
							<div class="form-group row">
                                <div class="col-md-2 col-lg-offset-1">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" readonly name="s_username" value="<?php echo session('shop.s_username');?>_<?php echo ($num); ?>">
                                </div>
                            </div>
							<div class="form-group row">
                                <div class="col-md-2 col-lg-offset-1">
                            ...
                            <div class="form-actions">
                                <div class="form-group row">
                                    <div class="col-md-6 col-md-offset-3">
                                        ...
                                        <a href="/index.php/Home/shop/show" class="btn btn-default">返回首页</a>
                                    </div>
                                </div>
                            </div>
                        </form>
