    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <div class="row">
                ...
                <div class="col-lg-12">
                    <h4><?php echo ($member[0][m_nickname]); ?> 充值日志</h4>
                    <!--<p>Modifier: <code>.table-inverse</code></p>-->
                    <a href="/index.php/Home/shop/memberXf?id=<?php echo ($member[0]['id']); ?>">
                    ...
                    <div class="margin-bottom-50">
                        <table class="table table-inverse">
                            ...
                            <tr><td colspan="3" style="text-align: right;font-size: 15px;"><?php echo ($page); ?></td></tr>
                            </tbody>
                        </table>
                    </div>
                </div>
