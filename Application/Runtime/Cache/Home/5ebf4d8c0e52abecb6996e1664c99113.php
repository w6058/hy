            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="margin-bottom-50">
                        ...
                        <!-- Horizontal Form -->
                        <h4><?php echo ($ref); ?></h4>
                        <form method="post" action="/hy2/index.php/Home/admin/memberBC">
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" value="<?php echo ($vo["m_nickname"]); ?>" placeholder="会员名称">
                                </div>
                            </div>
							<div class="form-group row">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-9">
                                   <input type="text" class="form-control" value='<?php echo ($vo["m_card"]); ?>' placeholder="会员卡号">
                                </div>
                            </div>
							<div class="form-group row">
                                <div class="col-md-3">
                                    <label class="form-control-label" for="l10">现有余额</label>
                                </div>
                                <div class="col-md-9">
                                    <input type="text" class="form-control"  value='<?php echo ($vo["m_num"]); ?>' placeholder="666 元">
                                </div>
                            </div>
							<div class="form-group row">
                                <div class="col-md-3">
                                    <label class="form-control-label" for="l0">充值资金</label>
                                </div>
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="num" placeholder="充值资金金额">
                                </div>
                            </div>
                            ...
                            <div class="form-actions">
                                <div class="form-group row">
                                    <div class="col-md-9 col-md-offset-3">
                                        <button type="sublimt" class="btn width-150 btn-primary">编辑</button>
                                         <a href="/hy2/index.php/Home/admin/index">
