...
<div class="page-content-inner">
    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-lg-12">
                    <h4><?php echo session('shop.s_name');?> 的管理员:</h4>
                    ...
                    <div class="table-responsive margin-bottom-50">
                        <table class="table table-hover">
                            ...
                            <tbody>
                            <?php if(is_array($admins)): foreach($admins as $key=>$admin): ?><!--<?php var_dump($val) ?>-->
                                <tr>
                                    <td><?php echo ($key+1); ?></td>
                                    <td><?php echo ($admin["s_name"]); ?></td>
                                    <td><?php echo ($admin["s_username"]); ?></td>
                                    <td><?php echo ($admin["s_phone"]); ?></td>
                                    <td><?php echo ($admin["s_email"]); ?></td>
                                    <!--<td>-->
                                        <!--<a href="/index.php/Home/shop/admindel?id=<?php echo ($admin["id"]); ?>">-->
                                            <!--<span class="label label-primary">  删除</span>-->
                                        <!--</a>-->
                                    <!--</td>-->
                                </tr><?php endforeach; endif; ?>
                            <tr><td colspan="5" style="text-align: right;font-size: 15px;"><?php echo ($page); ?></td></tr>
                            </tbody>
                        </table>
                    </div>
                </div>
