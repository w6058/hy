            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="margin-bottom-50">
                        <h4><?php echo ($shop["0"]["s_name"]); ?> 积分管理</h4>
                        <br />
                        <!-- Horizontal Form -->
                        <form method="post" action="/index.php/Home/admin/updatecash">
                            <input type="text" style="display: none" name="id" value="<?php echo ($shop[0]['id']); ?>">
                            <div class="form-group row">
                                <h3 style="color: red; text-align: center;margin-left: -25px;"><?php echo ($error); ?></h3>
                                <div class="col-md-1 col-md-offset-3">
                                    <label class="form-control-label">商户名称</label>
                                </div>
                                <div class="col-md-4">
                                    <input type="text" disabled value="<?php echo ($shop[0]['s_name']); ?>" class="form-control" name="s_name">
                                </div>
                            </div>
							<div class="form-group row">
                                <div class="col-md-1 col-md-offset-3">
                                    <label class="form-control-label">现有余额</label>
                                </div>
                                <div class="col-md-4">
                                    <input type="text" disabled value="<?php echo ($shop[0]['s_num']); ?>" class="form-control" name="s_num">
                                </div>
                            </div>
							<div class="form-group row">
                                <div class="col-md-1 col-md-offset-3">
                                    <label class="form-control-label">充值资金</label>
                                </div>
                                <div class="col-md-4">
                                    <input type="number" name="addcash" class="form-control">
                                </div>
                            </div>
							<div class="form-group row">
                                <div class="col-md-1 col-md-offset-3">
                                    <label class="form-control-label">扣除金额</label>
                                </div>
                                <div class="col-md-4">
                                    <input type="number" name="mcash"  class="form-control" >
                                </div>
                            </div>
                            <div class="form-actions">
                                <div class="form-group row">
                                    <div class="col-md-4 col-md-offset-5">
                                        <button type="submit" class="btn width-150 btn-primary">编辑</button>
                                        <a href="/index.php/Home/admin/shoplist"  class="btn btn-default">返回</a>
                                    </div>
                                </div>
                            </div>
                        </form>
