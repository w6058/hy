                            ...
                            <tbody>
                                <?php if(is_array($lists)): foreach($lists as $key=>$list): ?><!--<?php var_dump($val) ?>-->
                                    <tr>
                                        ...
                                        <td><a href="/index.php/Home/admin/messageinfo?id=<?php echo ($list["id"]); ?>"><?php echo ($list["title"]); ?></a></td>
                                        <td><?php echo ($list['0']); ?></td>
                                        <td><a href="/index.php/Home/admin/messagedel?id=<?php echo ($list["id"]); ?>"><span class="label label-primary">删除</span></a></td>
