    ...
    <div class="left-menu-inner scroll-pane">
        <ul class="left-menu-list left-menu-list-root list-unstyled">
            ...
            <li class="left-menu-list-submenu">
                ...
                <ul class="left-menu-list list-unstyled">
                    <li>
                        <a class="left-menu-link" href="/hy/index.php/Home/admin/shoplist">
                            商户列表
                        </a>
                    </li>
                    <li>
                        <a class="left-menu-link" href="/hy/index.php/Home/admin/addshop">
                            添加商户
                        </a>
                    </li>
                </ul>
            ...
            <li class="left-menu-list-submenu">
                ...
                <ul class="left-menu-list list-unstyled">
                    ...
                    <li>
                        <a class="left-menu-link" href="/hy/index.php/Home/admin/index">
                            会员列表
                        </a>
                    </li>
                    <li>
            ...
            <li class="left-menu-list-submenu">
                ...
                <ul class="left-menu-list list-unstyled">
                    <li>
                        <a class="left-menu-link" href="/hy/index.php/Home/admin/queryRecord">
                            充值记录
                        </a>
                    </li>
                    <li>
                        <a class="left-menu-link" href="/hy/index.php/Home/admin/queryRecordN">
                            消费记录
                        </a>
                    </li>
                </ul>
        ...
        <div class="menu-user-block">
            <div class="dropdown dropdown-avatar">
                ...
                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="" role="menu">
                    ...
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="/hy/index.php/Home/admin/logout"><i class="dropdown-icon icmn-exit"></i> 退出</a>
                </ul>
            </div>
        </div>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                                        ...
                                        <td>
                                            <a href="/hy/index.php/Home/Admin/moneyRecord?id=<?php echo ($vo["id"]); ?>">
                                                <span class="label label-primary">  资金记录</span>
                                            </a>
                                        </td>
                                        <td>
                                            <a href="/hy/index.php/Home/Admin/memberInfo?id=<?php echo ($vo["id"]); ?>">
                                                <span class="label label-primary">  会员详情</span>
                                            </a>
                                        </td>
                                        <td>
                                            <a href="/hy/index.php/Home/Admin/member?id=<?php echo ($vo["id"]); ?>">
                                                <span class="label label-primary">  余额编辑</span>
                                            </a>
                                        </td>
                                        <td>
                                            <a href="/hy/index.php/Home/Admin/memberF?id=<?php echo ($vo["id"]); ?>">
