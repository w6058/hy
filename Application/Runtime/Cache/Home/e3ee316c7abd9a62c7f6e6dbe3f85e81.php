                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
                                        ...
                                        <td><?php echo ($vo["m_level"]); ?></td>
                                        <td><?php echo ($vo["m_num"]); ?></td>
                                        <td>
                                            <a href="/index.php/Home/Admin/moneyRecord?id=<?php echo ($vo["id"]); ?>">
                                                <span class="label label-primary">  资金记录</span>
                                            </a>
                                        </td>
                                        <td>
                                            <a href="/index.php/Home/Admin/memberInfo?id=<?php echo ($vo["id"]); ?>">
                                                <span class="label label-primary">  会员详情</span>
                                            </a>
                                        </td>
                                        <td>
                                            <a href="/index.php/Home/Admin/member?id=<?php echo ($vo["id"]); ?>">
                                                <span class="label label-primary">  余额编辑</span>
                                            </a>
                                        </td>
                                        <td>
                                            <a href="/index.php/Home/Admin/memberF?id=<?php echo ($vo["id"]); ?>">
