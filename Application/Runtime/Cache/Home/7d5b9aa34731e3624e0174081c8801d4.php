                    ...
                    <div class="margin-bottom-50">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <th>管理员</th>
                                <th>工商运营资料</th>
                                <th colspan="2" class="text-center">法人身份证</th>
                                <th colspan="2" class="text-center">管理员身份证</th>
                                <th>同意</th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php if(empty($shops)): ?><tr>
                                    <td style="border: 1px solid black;" colspan="10">无未验证商家</td>
                                </tr><?php endif; ?>
                            <?php if(!empty($shops)): if(is_array($shops)): foreach($shops as $key=>$shop): ?><!--<?php var_dump($val) ?>-->
                                    <tr>
                                        <td style="height: auto;margin: auto"><?php echo ($key+1); ?></td>
                                        <td style="height: auto;margin: auto"><?php echo ($shop["s_name"]); ?></td>
                                        <td style="height: auto;margin: auto"><?php echo ($shop["s_username"]); ?></td>
                                        <td><a target="_blank" class="smallimage" rel="/Uploads/<?php echo ($shop["s_document"]); ?>" href="/Uploads/<?php echo ($shop["s_document"]); ?>"><img style="width: 150px;height: 100px;" src="/Uploads/<?php echo ($shop["s_document"]); ?>" alt="工商运营资料"></td>
                                        <td><a target="_blank" class="smallimage" rel="/Uploads/<?php echo ($shop["s_fidcard_f"]); ?>" href="/Uploads/<?php echo ($shop["s_fidcard_f"]); ?>"><img style="width: 150px;height: 100px;" src="/Uploads/<?php echo ($shop["s_fidcard_f"]); ?>" alt="法人身份证正面"></td>
                                        <td><a target="_blank" class="smallimage" rel="/Uploads/<?php echo ($shop["s_fidcard_b"]); ?>" href="/Uploads/<?php echo ($shop["s_fidcard_b"]); ?>"><img style="width: 150px;height: 100px;" src="/Uploads/<?php echo ($shop["s_fidcard_b"]); ?>" alt="法人身份证反面"></td>
                                        <td><a target="_blank" class="smallimage" rel="/Uploads/<?php echo ($shop["s_aidcard_f"]); ?>" href="/Uploads/<?php echo ($shop["s_aidcard_f"]); ?>"><img style="width: 150px;height: 100px;" src="/Uploads/<?php echo ($shop["s_aidcard_f"]); ?>" alt="管理员身份证正面"></td>
                                        <td><a target="_blank" class="smallimage" rel="/Uploads/<?php echo ($shop["s_aidcard_b"]); ?>" href="/Uploads/<?php echo ($shop["s_aidcard_b"]); ?>"><img style="width: 150px;height: 100px;" src="/Uploads/<?php echo ($shop["s_aidcard_b"]); ?>" alt="管理员身份证反面"></td>
                                        <td><a href="/index.php/Home/admin/cash?id=<?php echo ($shop["id"]); ?>"><span class="label label-primary">充值</span></a></td>
